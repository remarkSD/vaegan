...
if __name__ == '__main__':
    ...
    decoder_model = Model([inputs, z_in], [outputs1[0], outputs1[1], outputs2[0], outputs3[1]], name='decoder')
    gamma = 1e-6
    ...
    for i in range (epochs):
        for j in range (int(save_interval)):
            ...
            if j % 200 == 0:
                ...
                z_sample =  np.random.uniform(size=(batch_size, z_dim), low=-1.0, high=1.0)
